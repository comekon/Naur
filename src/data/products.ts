...
export const products: Product[] = [
	// Minuman RTD
	{
		...
		description:
			"Perpaduan daun jasmine premium dari Puncak dengan susu segar. Aroma floral yang lembut dan rasa creamy yang menyenangkan di setiap tegukan.",
	...
	},
	{
		...
		description:
			"Oolong dari Wonosobo dengan karakter roasted nutty yang khas, dipadukan dengan susu steamed untuk menghasilkan latte yang smooth dan memuaskan.",
		brewGuide:
			"Disajikan panas atau dingin. Untuk oolong latte dingin, tambahkan es batu.",
		badges: ["new"],
		stock: 40,
	},
	{
		...
		description:
			"Grade ceremonial matcha dari Uji, Jepang. Diseduh dengan tehnik tradisional, menghasilkan froth yang creamy dan rasa umami yang mendalam.",
		brewGuide:
			"Disajikan panas. Matcha di-whisk hingga berbusa. Best consumed segera.",
	...
	},
	{
		...
		description:
			"Daun teh hitam dari Kerinci yang di-cold brew selama 12 jam. Hasilnya smooth, minim rasa pahit, dan naturally sweet tanpa tambahan gula.",
	...
	// Teh Kemasan
	{
		...
		description:
			"Daun teh orthodox dari kaki Gunung Kerinci, Sumatera. Karakter mineral dan smoky yang khas, cocok untuk penggemar teh yang ingin menjelajahi terroir Indonesia.",
	...
	},
	{
		...
		description:
			"Teh dari perkebunan Wonosobo, Jawa Tengah. Aroma floral yang khas dengan body buttery dan clean finish yang memanjakan lidah.",
		brewGuide:
			"Suhu air 85°C. Steep 3 menit. Bisa di-infuse ulang hingga 3 kali.",
		badges: [],
		stock: 30,
	},
	{
		...
		description:
			"Green tea dari Puncak, Bogor. Karakter bright dan citrusy yang refreshing, cocok untuk daily tea drinking.",
		brewGuide:
			"Suhu air 75°C. Steep 2 menit. Jangan over-steep untuk menghindari rasa pahit.",
		badges: ["bestseller"],
		stock: 45,
	},
	...
	// Alat Seduh
	{
		...
		tastingNotes: "-",
		description:
			"Teapot keramik handmade dengan glasir hitam matte. Kapasitas 350ml, cocok untuk 2-3 cangkir. Desain minimalis yang bold.",
	...
	},
	{
		...
		tastingNotes: "-",
		description:
			"Infuser stainless steel 304 food-grade dengan lubang halus. Cocok untuk loose leaf tea. Panjang 12cm, muat di sebagian besar gelas.",
		brewGuide:
			"Masukkan 1-2 sendok teh, tuang air panas, tunggu sesuai waktu steep.",
		badges: [],
		stock: 50,
	},
	...
	// Merchandise
	{
		...
		tastingNotes: "-",
		description:
			"Tumbler stainless 500ml dengan desain api geometris Naur. Double wall insulation, keep hot 6 jam / cold 12 jam. BPA-free.",
		brewGuide: "-",
		badges: ["bestseller"],
		stock: 35,
	},
	{
		...
		tastingNotes: "-",
		description:
			"Tote bag katun premium dengan print api geometris besar. Ukuran 38x42cm, muat laptop 14 inch. Tali tebal dan kuat.",
		brewGuide: "-",
		badges: ["bestseller"],
		stock: 40,
	},
	{
		...
		tastingNotes: "-",
		description:
			'Kaos cotton combed 30s dengan print "Nyalakan Momenmu" dan ilustrasi api. Available S/M/L/XL. Warna hitam.',
		brewGuide: "-",
		badges: ["new"],
		stock: 20,
	},
	{
		...
		tastingNotes: "-",
		description:
			"Snapback hitam dengan bordir logo api Naur di depan. Adjustable strap, one size fits most.",
		brewGuide: "-",
		badges: [],
		stock: 25,
	},
	{
		...
		tastingNotes: "-",
		description:
			"Pin enamel berbentuk api Naur dengan finishing glossy. Diameter 2.5cm. Clutch back yang kuat.",
		brewGuide: "-",
		badges: ["limited"],
		stock: 100,
	},
	...
	// Bundling
	{
		...
		tastingNotes: "-",
		description:
			"Semua yang kamu butuhkan untuk mulai: 3 varian teh kemasan (Kerinci, Wonosobo, Puncak) + tea infuser + panduan brewing.",
	...
	},
	{
		...
		tastingNotes: "-",
		description:
			"Box premium berisi: 2 teh kemasan + 1 merch eksklusif + tumbler Naur + kartu ucapan. Packaging khusus untuk hadiah.",
		brewGuide: "-",
		badges: ["limited"],
		stock: 5,
	},
