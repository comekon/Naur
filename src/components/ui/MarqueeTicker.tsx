...
export default function MarqueeTicker({
  ...
  return (
    ...
    >
      <div
        className={cn("animate-marquee flex whitespace-nowrap", paused && "!animate-none")}
        style={{ animationDuration: speedDuration[speed] }}
        aria-hidden="true"
      >
        <span className="font-display font-bold uppercase tracking-widest text-lg text-secondary mr-8">
          {content}
        </span>
        <span className="font-display font-bold uppercase tracking-widest text-lg text-secondary mr-8">
          {content}
